...
describe ApplicationController do
  ...
  describe 'Signup Page' do
    ...
    it 'does not let a logged in user view the signup page' do
      user = User.create(username: 'skittles123',
                         email: 'skittles@aol.com',
                         password: 'rainbows')
      params = { username: 'skittles123',
                 email: 'skittles@aol.com',
  ...
  describe 'login' do
    ...
    it 'does not let user view login page if already logged in' do
      user = User.create(username: 'becky567',
                         email: 'starz@aol.com',
                         password: 'kittens')
      params = { username: 'becky567', password: 'kittens' }
      post '/login', params
  ...
  describe 'index action' do
    context 'logged in' do
      it 'lets a user view the tweets index if logged in' do
        user1 = User.create(username: 'becky567',
                            email: 'starz@aol.com',
                            password: 'kittens')
        tweet1 = Tweet.create(content: 'tweeting!', user_id: user1.id)
        user2 = User.create(username: 'silverstallion',
                            email: 'silver@aol.com',
                            password: 'horses')
    ...
    context 'logged in' do
      it 'displays a single tweet' do
        user = User.create(username: 'becky567',
                           email: 'starz@aol.com',
                           password: 'kittens')
        tweet = Tweet.create(content: 'i am a boss at tweeting',
                             user_id: user.id)
    ...
    context 'logged in' do
      ...
      it 'does not let a user edit a tweet they did not create' do
        user1 = User.create(username: 'becky567',
                            email: 'starz@aol.com',
                            password: 'kittens')
        Tweet.create(content: 'tweeting!', user_id: user1.id)
        user2 = User.create(username: 'silverstallion',
                            email: 'silver@aol.com',
                            password: 'horses')
        tweet2 = Tweet.create(content: 'look at this tweet', user_id: user2.id)
      ...
      it 'lets a user edit their own tweet if they are logged in' do
        User.create(username: 'becky567',
                    email: 'starz@aol.com',
                    password: 'kittens')
        Tweet.create(content: 'tweeting!', user_id: 1)
        visit '/login'
        ...
        expect(Tweet.find_by(content: 'i love tweeting'))
          .to be_instance_of(Tweet)
